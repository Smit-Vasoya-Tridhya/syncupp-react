...
export default function Cancellationandrefundform() {
  ...
  const onSubmit: SubmitHandler<CkeditorSchema> = (data) => {
    ...
    dispatch(Editcancllation(formData)).then((result: any) => {
      if (Editcancllation.fulfilled.match(result)) {
  ...
  console.log(termAndCondition?.conatcUSdata, 'data');
