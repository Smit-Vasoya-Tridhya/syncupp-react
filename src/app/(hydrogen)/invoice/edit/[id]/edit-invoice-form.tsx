...
export default function EditInvoice({ params }: { params: { id: string } }) {
  ...
  const SingleInvoiceData = useSelector((state: any) => state?.root?.invoice)?.getInvoiceDataByIDdata?.data[0]
  ...
  const IncrementQtyHandler = (values: any, setFieldValue: any, index: any) => {
    setFieldValue(
  ...
  const DecrementQtyHandler = (values: any, setFieldValue: any, index: any) => {
    setFieldValue(
      `invoice_content[${index}].qty`,
      (prevQty: number) => Math.max(0, prevQty - 1)
    );
  };



  if (InvoiceLoader || loading) {
                                            ...
                                            suffix={
                                              <>
                                                <ActionIcon
                                                  ...
                                                  onClick={() => { DecrementQtyHandler(values, setFieldValue, index) }}
                                                // onClick={() => {
                                                //   setFieldValue(
                                                //     `invoice_content[${index}].qty`,
                                                ...
                                                <ActionIcon
                                                  ...
                                                  variant="outline"
                                                  className="scale-90 shadow-sm"
                                                  onClick={() => { IncrementQtyHandler(values, setFieldValue, index) }}
                                                // onClick={() => {
                                                //   setFieldValue(
                                                //     `invoice_content[${index}].qty`,
                                                //     +values.invoice_content[
