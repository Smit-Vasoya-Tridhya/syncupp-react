export const messages = {
  ...
  titleLength: 'Maximum title length is 50',
  InvoiceNumberIsRequired: 'Invoice Number is required with minimum lenggth is 2',
  InvoiceNumberMaxLength: 'Make sure invoice number maximum lenghth is 10',
  ...
  reviewLength: 'Maximum description length is 150',
  reviewMaxLength: 'Maximum review length is 150',
